...
<head>
    ...
    <link rel="apple-touch-icon" sizes="72x72" href="assets/images/img/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="assets/images/img/apple-touch-icon-114x114.png">
...
<div id="tf-portfolio">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="assets/images/img/09.jpg" class="img-responsive">
            </div>

            <div class="col-md-4">
                <img src="assets/images/img/02.jpg" class="img-responsive">
            </div>

            <div class="col-md-4">
                <img src="assets/images/img/03.jpg" class="img-responsive">
            </div>
        </div>

        <div class="row toppadding">
            <div class="col-md-4">
                <img src="assets/images/img/04.jpg" class="img-responsive">
            </div>

            <div class="col-md-4">
                <img src="assets/images/img/05.jpg" class="img-responsive">
            </div>

            <div class="col-md-4">
                <img src="assets/images/img/06.jpg" class="img-responsive">
            </div>
        </div>
